...
FINAL_IMAGE=${DISTDIR}/watchdog.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/watchdog.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
